        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <img src="/itemImage/{{ $item->product_image }}" class="rounded mx-auto d-block"
                            alt="..." height="300px">
                    </div>
                        ...
                        <form action="{{ route('update', $item->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="product_name" placeholder="Product name"
                                    ...
                                    aria-describedby="inputGroup-sizing-default" value={{ $item->product_name }}>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="product_price" placeholder="Product price"
                                    class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-default" value={{ $item->product_price }}>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <input type="file" name="product_image" class="form-control"
                                    ...
                                    aria-label="Upload" value={{ $item->product_image }}>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" id="inputGroupSelect01" name="product_category">
                                    ...
                                    <option value="T-shirt"
                                        {{ $item->product_category == 'T-shirt' ? 'selected' : '' }}>
                                        T-shirt</option>
                                    <option value="Gadget" {{ $item->product_category == 'Gadget' ? 'selected' : '' }}>
                                        Gadget</option>
                                    <option value="Electronics"
                                        {{ $item->product_category == 'Electronics' ? 'selected' : '' }}>Electronics
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="product_quantity" placeholder="Product quantity"
                                    class="form-control" aria-label="Sizing example input"
                                    aria-describedby="inputGroup-sizing-default" value={{ $item->product_quantity }}>
                            </div>

                            <div class="input-group mb-3">
                                <button class="form-control btn btn-success" type="submit">Update Product</button>
                            </div>
                        </form>
